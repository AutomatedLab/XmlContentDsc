Task UnitTest {
    ...
    $testFileName = "UnitTestResults.xml"
    ...
    $testResults = Invoke-Pester -Path "$(property BHPSModulePath)\Tests\Unit" -PassThru -OutputFormat NUnitXml -OutputFile "$(property BHBuildOutput)\Pester\$testFileName"
